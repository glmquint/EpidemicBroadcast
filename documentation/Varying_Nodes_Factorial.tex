...
To draw easier conclusion, in the following section, these result are plotted in a scatter plot with lines. Note that the values underlined are referred to influence of factors with a negative contribution.
